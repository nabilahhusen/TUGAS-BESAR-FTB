...
<div class="row justify-content-center">
    ...
    <h1 class="h3 text-center mb-3" style="font-weight:600;">Aplikasi<span class="text-primary"> Kasir Kelompok</span></h1>
        ...
        <div class="text-center small mt-4">
            <p class="text-muted">Aplikasi Kasir Kelompok © <?php echo date('Y');?> </p>
        </div>
    </div>
